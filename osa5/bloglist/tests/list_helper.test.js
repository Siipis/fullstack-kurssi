...
describe('total likes', () => {
  ...
  test('when list has many the total is calculated correctly', () => {
...
describe('favourite blogs', () => {
  ...
  test('when list has many the highest likes is returned', () => {
...
describe('most blogs', () => {
  ...
  test('when list has many the author most blogs is returned', () => {
